...
import root.gast.playground.image.detectfaces.DetectFaces;
import android.hardware.Camera;
import android.hardware.Camera.CameraInfo;
import android.os.Bundle;
import android.widget.Toast;

public class DetectFacesActivity extends ManageCameraActivity
{
    private DetectFaces mDetectFaces;
    ...
    protected void onResume()
    {
        ...
        mCamera.setPreviewCallback(mDetectFaces);
    }
